...
public class EsayVideoEditActivity extends AppCompatActivity implements RangeBar.OnRangeBarChangeListener {
    ...
    private static String TAG = "EsayVideoEditActivity";
    ...
    private RecyclerView.OnScrollListener onScrollListener=new RecyclerView.OnScrollListener() {
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            ...
            if (newState==RecyclerView.SCROLL_STATE_IDLE){
                ...
                Log.i("onScrollStateChanged","lastItem :"+lastItem+"=====dataList=="+dataList.size());
    ...
    private void runImagDecodTask(final int start,final int count){
        Log.i("EsayVideoEditActivity","start====="+start+"====count===="+count);
        executorService.execute(new Runnable() {
            @Override
            public void run() {
